...
function voltearVertical(matriz) {
  ...
  // Recorremos de abajo hacia arriba para invertir el orden de las filas
  for (let i = matriz.length - 1; i >= 0; i--) {
    // Copiamos la fila actual y hacemos una copia por valor de cada pixel
    const filaCopiada = matriz[i].map(px => ({
